...
type stubClient struct {
	...
	startLogs        func(context.Context, string) tea.Cmd
}
...
func newStubClient() *stubClient {
	...
	return &stubClient{
		...
		fetchStats:       noopStr,
		startLogs:        func(_ context.Context, _ string) tea.Cmd { return noop },
	}
}
...
func (c *stubClient) StartLogs(ctx context.Context, id string) tea.Cmd { return c.startLogs(ctx, id) }
