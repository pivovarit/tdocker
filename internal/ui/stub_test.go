...
type stubClient struct {
	...
	startLogs        func(string) (tea.Cmd, func())
}
...
func newStubClient() *stubClient {
	...
	return &stubClient{
		...
		fetchStats:       noopStr,
		startLogs:        func(_ string) (tea.Cmd, func()) { return noop, func() {} },
	}
}
...
func (c *stubClient) StartLogs(id string) (tea.Cmd, func()) { return c.startLogs(id) }
